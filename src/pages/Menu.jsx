...
const Menu = () => {
  ...
  return (
    <section className="flex flex-col gap-5 justify-evenly items-center h-4/6 w-5/6 md:w-7/12 md:justify-center md:gap-8 xl:h-5/6 xl:w-5/12 2xl:w-4/12 landmobileSS:landscape-menu">
      <div className="py-2">
        <Logo />
      </div>
      <Card className="h-3/6 w-full flex flex-col justify-between items-center py-4 text-custom-silver md:h-1/4 lg:h-1/3 xl:h-2/6 landmobileSS:landscape-selection-menu">
