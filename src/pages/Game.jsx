...
const Game = () => {
  ...
  return (
    <section className="h-5/6 mt-5 mb-auto w-11/12 flex flex-col justify-between md:justify-center md:w-9/12 md:m-auto md:gap-8 lg:h-5/6 lg:max-w-lg sxl:max-w-lg 2xl:w-4/12 2xl:max-w-3xl landmobileSS:landscape-game fourK:max-w-7xl">
      <GameHeader />
      <GameBoard />
